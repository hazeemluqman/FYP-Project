...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        <div>
            ...
            <p class="text-gray-600 mt-1">Worker access details and activity history</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 p-6">
            ...
            <div class="space-y-4">
                <div
                    ...
                    <div>
                        <h3 class="text-sm font-medium text-gray-500">RFID Card</h3>
            ...
            <div class="space-y-4">
                ...
                <div
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-900">
                            @php
                            // Get the most recent checkpoint activity
